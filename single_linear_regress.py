...
Result: 
    ...
    p_s2025_a: vector with our predicted assist values        
'''
season_X = np.array([[1,2020], [1,2021], [1,2022], [1,2023], [1,2024]]) 
assist_Y = merged['A'].values  
assist_Y = assist_Y.T 
...
#print(merged['predict_A_2025'].sort_values(ascending=False).head(10))

#print(merged['P/GP '].mean())
